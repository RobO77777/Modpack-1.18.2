onEvent('fluid.registry', event => {
    ...
    event.create('magical_primary_energy').stillTexture('kubejs:block/fluid/magical_primary_energy_still').flowingTexture('kubejs:block/fluid/magical_primary_energy_flow').displayName('Liquid Primary Energy').luminosity(15);
})
